export const exercises = [
  ...
  // === Ex3: Заполните нарратив (10 items) ===
  {
    type: "choice",
  ...
  // === Ex5: Переведите на португальский (12 items) ===
  {
    type: "translate",
    source: "Вчера был интересный день.",
    direction: "ru-pt",
    answer: ["Ontem foi um dia interessante."]
  },
  {
    type: "translate",
    source: "Ей понравилась вечеринка?",
    direction: "ru-pt",
    answer: ["Ela gostou da festa?"]
  },
  {
    type: "translate",
    source: "Они вчера разбили вазу.",
    direction: "ru-pt",
    answer: ["Eles partiram o vaso ontem."]
  },
  {
    type: "translate",
  ...
  {
    type: "translate",
    source: "Гость написал ему письмо.",
    direction: "ru-pt",
    answer: ["O convidado escreveu-lhe uma carta."]
  },
  {
    type: "translate",
    source: "Он завёл новую подругу.",
    direction: "ru-pt",
    answer: ["Ele fez uma amiga nova."]
  },
  {
    type: "translate",
    source: "Поезд приехал с опозданием.",
    direction: "ru-pt",
    answer: ["O comboio chegou atrasado."]
  },
  {
    type: "translate",
  ...
  {
    type: "translate",
    source: "Ты пришёл домой очень поздно.",
    direction: "ru-pt",
    answer: ["Tu foste para casa muito tarde.", "Foste para casa muito tarde."]
  },
  {
    type: "translate",
    source: "Мы закончили проект.",
    direction: "ru-pt",
    answer: ["Terminámos o projeto.", "Nós terminámos o projeto."]
  },
  {
    type: "translate",
  ...
  // === Дополнительные упражнения: match, order ===
  {
    type: "match",
  ...
  {
    type: "order",
    question: "Составьте предложение: «Вчера я поговорил с директором.»",
    words: ["Ontem", "falei", "com", "o", "diretor"],
    answer: "Ontem falei com o diretor."
  },
  {
    type: "choice",
    ...
    options: [
      "меняется корень",
      "добавляется акцент: falámos",
      "окончание другое: -emos",
      "ничем не отличается"
    ],
    correct: 1,
    explanation: "В европ. португальском: falámos (Pretérito Perfeito) vs falamos (Presente). Акцент помогает различать времена."
  },
  {
    type: "order",
    question: "Составьте предложение: «Она купила новое платье.»",
    words: ["Ela", "comprou", "um", "vestido", "novo"],
    answer: "Ela comprou um vestido novo."
  }
];
