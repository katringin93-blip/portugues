export default {
  ...
  flashcards: [
    ...
    { ru: "some", hint: "f. plural" },
    { ru: "carnival", hint: "masculine" },
    { ru: "rain", hint: "feminine" },
    { ru: "to close", hint: "verb" },
    { ru: "commercial establishments", hint: "m. pl." },
    { ru: "opening hours", hint: "masculine" },
    { ru: "Christmas", hint: "masculine" },
    { ru: "snow", hint: "feminine" },
    { ru: "in general", hint: "adverb" },
    { ru: "namely", hint: "adverb" },
    { ru: "normally, usually", hint: "adverb" },
    { ru: "Easter", hint: "feminine" },
    { ru: "however", hint: "conjunction" },
    { ru: "time; weather", hint: "masculine" },
